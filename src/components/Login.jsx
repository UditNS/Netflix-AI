  ...
  return (
    <div className="relative bg-black h-screen">
      ...
      <form
        ...
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col space-y-4 text-center w-2/6 bg-black/70 py-18 px-14 rounded-sm "
      >
        <p className="text-white flex font-semibold text-3xl items-start w-full mb-8">
        ...
        <input
          ...
          type="email"
          placeholder="Email"
          className={`px-4 py-3 mb-4 rounded-sm bg-[#1e201f]/60 text-white border border-gray-500 outline-none ${
            errorEmail ? "ring-red-500 ring-2" : "focus:ring-2 focus:ring-white"
          } w-full`}
        />
        <p
        ...
        <input
          ...
          className={`px-4 py-3 mb-4 rounded-sm bg-[#1e201f]/60 text-white border border-gray-500 ${
            errorPassword
              ? "ring-red-500 ring-2"
