...
function VideoPlayback({id}) {
    ...
    return (
        <div className=''><iframe className='w-full aspect-video absolute'  src={`https://www.youtube.com/embed/${selector.key}?autoplay=1&mute=1&controls=0&modestbranding=1&rel=0&showinfo=0`
